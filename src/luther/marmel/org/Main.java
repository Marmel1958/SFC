...
public class Main extends Activity implements ActionBar.TabListener {
	...
	public AgendaFragment agendaFragment = AgendaFragment.newInstance(1);
	public MapFragment mapFragment = MapFragment.newInstance(2);
	public InfoFragment infoFragment = InfoFragment.newInstance(3);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (id) {
		case R.id.selfPoint:
			mapFragment.setSelfLocation(true);
			return true;
		case R.id.routing:
			return true;
		case R.id.gmaps:
			Uri uri=Uri.parse("geo:"+String.valueOf(mapFragment.getLastGeoPoint().getLatitude())+","+String.valueOf(mapFragment.getLastGeoPoint().getLongitude()));
			Intent gmapsIntent=new Intent(Intent.ACTION_VIEW,uri);
			gmapsIntent.setPackage("com.google.android.apps.maps");
			if(gmapsIntent.resolveActivity(getPackageManager())!=null)
		...
		case R.id.mySettings:
			return true;
		case R.id.help:
			Intent helpInfo = new Intent(this, HelpActivity.class);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			switch (position) {
			case 0:
				return getString(R.string.agenda).toUpperCase(l);
			case 1:
